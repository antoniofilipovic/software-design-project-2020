...
<form:form  action="/editInfo/visitor/${id}" method="post" modelAttribute="editedVisitor">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 polja">
				<div class="form-group row">
	                ...
	                <div class="col-md-6">
	                    <form:input type="text" class="form-control" path="fullName" id="inputKey" placeholder="" />
	                </div>
            	</div>
				...
				<div class="form-group row">
	                <label for="inputKey" class="col-md-4 control-label">Nadimak</label>
	                <div class="col-md-6">
	                    <form:input type="text" class="form-control" path="nick" id="inputSt" placeholder="" />
	                </div>
	            </div>
