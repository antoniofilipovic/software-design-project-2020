...
<head>
	<meta charset="UTF-8">
	<title>Pregled organizatora</title>
...
<body>
	...
	<div class="container">
		<c:forEach items="${organisers}" var="organiser">
			<div class="row dogadaj">
				...
				<div class="col-md-6 polja">
					...
					<div class="form-group row">
				        ...
				        <div class="col-md-4">
				        	<label  class="control-label">${organiser.fullName}</label>
				        </div>
	            	</div>
	            	...
	            	<div class="form-group row">
				        ...
				        <div class="col-md-4">
				        	<label  class="control-label">${organiser.userType}</label>
				        </div>
	            	</div>
	            	
	            	<div class="form-group row">
		                <label  class="col-md-6 control-label">Email korisnika</label>
				        <div class="col-md-4">
				...
				<div class="col-md-2 polja ">
					<a class="btn gumbi" href="/manageAccount/${organiser.userType}/${organiser.id}">Više o korisniku</a>
